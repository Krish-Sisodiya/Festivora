// File: src/components/SettingsModal.tsx (FINAL FIXED & OPTIMIZED)
...
const SettingsModal: React.FC<SettingsModalProps> = ({
    ...
    return (
        <div
            className="fixed inset-0 bg-black/60 z-50 flex items-center justify-end backdrop-blur-sm"
            onClick={onClose}
        >
            <div
                className="bg-white dark:bg-gray-800 h-full w-full max-w-sm p-6 shadow-2xl
            ...
            >
                ...
                <div className="flex justify-between items-center mb-8 border-b border-gray-200 dark:border-gray-700 pb-3">
                    <h3 className="text-2xl font-extrabold text-gray-900 dark:text-white flex items-center">
                        <Palette className="w-6 h-6 mr-2 text-yellow-600 dark:text-yellow-400" />
                        App Settings
                    </h3>
                    <button
                        onClick={onClose}
                ...
                {/* Theme Section */}
                <div className="mb-8 p-4 border border-gray-200 dark:border-gray-700 rounded-xl 
                                bg-gray-50 dark:bg-gray-900/50">
                    <h4 className="font-bold text-xl mb-3 flex items-center text-gray-800 dark:text-gray-200">
                        <Sun className="w-5 h-5 mr-3 text-yellow-600 dark:text-yellow-400" />
                        Display Theme
                    </h4>
                    ...
                    <div className="flex space-x-3 bg-gray-100 dark:bg-gray-800 p-1.5 rounded-xl shadow-inner">
                        <button
                            ...
                            className={`flex items-center justify-center w-1/2 py-3 rounded-xl transition-all duration-300 
                ...
                <div className="mb-8 p-4 border border-gray-200 dark:border-gray-700 rounded-xl 
                                bg-gray-50 dark:bg-gray-900/50">
                    <h4 className="font-bold text-xl mb-3 flex items-center text-gray-800 dark:text-gray-200">
                        <Globe className="w-5 h-5 mr-3 text-yellow-600 dark:text-yellow-400" />
                        Language
                    </h4>
                    ...
                    <select
                        ...
                        className="w-full p-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 
                                   dark:text-white rounded-lg focus:ring-yellow-500 focus:border-yellow-500 
                                   appearance-none bg-white transition shadow-sm"
                    >
