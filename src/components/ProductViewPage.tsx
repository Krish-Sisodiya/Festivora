// File: src/components/ProductViewPage.tsx (⚡ Lighting Theme Premium Version)
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 bg-white dark:bg-gray-800 p-2 rounded-full shadow-lg hover:bg-yellow-100 dark:hover:bg-yellow-600/20 transition"
        >
          <X className="w-6 h-6 text-gray-700 dark:text-gray-300" />
        </button>

        {/* 🔆 Content */}
        <div ref={scrollRef} className="p-6 md:p-10 overflow-y-auto max-h-[90vh]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <p className="text-lg text-yellow-700 dark:text-yellow-400 font-semibold mb-3">
                {product.shortDesc}
              </p>
              ...
              <div className="flex items-center mb-5">
                ...
                <span className="text-xl font-semibold text-yellow-600">5.0</span>
                <span className="ml-2 text-gray-500 dark:text-gray-400">Customer Rating</span>
              </div>
              ...
              {/* 🧾 Specifications */}
              <div className="p-5 bg-yellow-50 dark:bg-gray-800 rounded-xl border border-yellow-100 dark:border-gray-700 mb-8">
                <h2 className="text-xl font-bold text-yellow-800 dark:text-yellow-400 mb-4 flex items-center">
                ...
                <ul className="space-y-2 text-sm">
                  {specifications.map((spec, i) => (
                    ...
                    >
                      ...
                      <span className="ml-4">{spec.value}</span>
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className="space-y-4 border-t border-gray-200 dark:border-gray-700 pt-4">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 text-white font-bold py-4 rounded-lg shadow-lg hover:shadow-[0_0_20px_rgba(255,215,0,0.4)] transition-all active:scale-[0.98] flex items-center justify-center text-lg"
                >
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <a
                    ...
                    className="w-full sm:w-1/2 bg-yellow-600 text-white py-3 rounded-lg text-sm font-semibold hover:bg-yellow-700 flex items-center justify-center gap-2 shadow"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full sm:w-1/2 bg-amber-700 text-white py-3 rounded-lg text-sm font-semibold hover:bg-amber-800 flex items-center justify-center gap-2 shadow"
                  >
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <a
                    ...
                    className="w-full sm:w-1/2 bg-green-500 hover:bg-green-600 text-white font-semibold py-3 rounded-lg shadow flex items-center justify-center gap-2"
                  >
                    <Phone className="w-5 h-5" /> Call / WhatsApp
                  </a>
                  <button
                    onClick={handleShareEmail}
                    className="w-full sm:w-1/2 bg-red-500 hover:bg-red-600 text-white font-semibold py-3 rounded-lg shadow flex items-center justify-center gap-2"
                  >
                ...
                <div className="text-center text-gray-500 dark:text-gray-400 text-sm pt-3 flex justify-center items-center">
          ...
          {relatedProducts.length > 0 && (
            <div className="mt-14 border-t border-gray-200 dark:border-gray-700 pt-8">
              <h2 className="text-2xl font-bold mb-6 text-yellow-700 dark:text-yellow-400 border-b-2 border-yellow-400 inline-block pb-1">
                Similar Products
              </h2>
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-5">
                {relatedProducts.map((p) => (
                  <motion.div
                    ...
                    className="cursor-pointer bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-3 rounded-xl shadow-md hover:shadow-[0_0_15px_rgba(255,215,0,0.3)] transition"
                  >
                    <img
                      src={p.images[0]}
                      alt={p.title}
