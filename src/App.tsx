// File: src/App.tsx (⚡ Festivora Prime Build Edition ✅)
...
import { baseProducts, sampleReviews } from "./data/Product";
import type {
  Product,
  CategoryName,
  Theme,
...
const PolicyContentData: Record<string, PolicyContent> = {
  privacy: {
    ...
    content: "<p>We follow strict data protection and privacy standards to safeguard user information.</p>",
  },
  terms: {
    title: "Terms of Service",
    content: "<p>By using Festivora, you agree to comply with our terms and conditions outlined here.</p>",
  },
  shipping: {
    title: "Shipping & Returns",
    content: "<p>Standard delivery time is 5–7 days. Returns accepted within 7 days of delivery.</p>",
  },
  warranty: {
    title: "Warranty Information",
    content: "<p>All our lighting products include a 6-month limited warranty against manufacturing defects.</p>",
  },
};
...
const App: React.FC = () => {
  ...
  const handleSearch = (q: string) => {
    if (!q.trim()) return handleResetView();
    setSearchQuery(q);
  ...
  switch (pageState.view) {
    case "policy":
      const policy = PolicyContentData[pageState.policyKey || "privacy"];
      content = (
        <GenericContentPage
          title={policy.title}
  ...
  return (
    <div
      className={`${
        theme === "dark" ? "dark bg-gray-900 text-gray-100" : "bg-gray-50 text-gray-800"
    ...
    >
      ...
      <Navbar
        ...
        onViewAllProducts={() => setPageState({ view: "allProducts", category: "All" })}
        onGoHome={handleResetView}
